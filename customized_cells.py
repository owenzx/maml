...
class Customized_BasicLSTMCell(tf.contrib.rnn.LayerRNNCell):
  ...
  def __init__(self,
    ...
    """
    super(Customized_BasicLSTMCell, self).__init__(_reuse=reuse, name=name, dtype=dtype)
...
class Customized_LayerNormBasicLSTMCell(tf.nn.rnn_cell.RNNCell):
